...
import (
	"crypto"
	"crypto/rand"
	bccsp2 "github.com/hyperledger/fabric-sdk-go/internal/github.com/hyperledger/fabric/bccsp"

	// "crypto/x509"
	"encoding/hex"

	x509 "gitee.com/china_uni/tjfoc-gm/x509"
...
func (id *identity) getHashOpt(hashFamily string) (core.HashOpts, error) {
	...
	case bccsp2.SM3:
		return bccsp2.GetHashOpt(bccsp2.SM3)
