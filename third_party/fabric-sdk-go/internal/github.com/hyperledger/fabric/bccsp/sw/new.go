...
func NewWithParams(securityLevel int, hashFamily string, keyStore bccsp.KeyStore) (bccsp.BCCSP, error) {
	...
	//swbccsp.AddWrapper(reflect.TypeOf(&bccsp.RSAPrivateKeyImportOpts{}), &rsaPrivateKeyImportOptsKeyImporter{})   //add by liuhy support rsa
	//swbccsp.AddWrapper(reflect.TypeOf(&bccsp.RSAGoPublicKeyImportOpts{}), &rsaGoPublicKeyImportOptsKeyImporter{}) //add by liuhy
